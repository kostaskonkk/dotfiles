...
alias carfs='sudo sshfs -o allow_other odroid@192.168.0.102:/ /mnt/dsv'
...
# Time related
alias ch='ntpdate -q 192.168.0.101'
alias adjust_time='sudo ntpdate -u pool.ntp.org'

# ROS
export ROS_MASTER_URI=http://localhost:11311
source /opt/ros/kinetic/setup.bash
source ~/datmo_ws/devel/setup.bash
# source ~/slam_ws/install_isolated/setup.bash
...
alias obag='roslaunch odometry odom_bag.launch'
alias oviz='roslaunch odometry viz_odom.launch'
...
alias readme='vim /home/kostas/master_ws/src/datmo/README.md'
