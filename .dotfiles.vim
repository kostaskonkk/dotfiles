...
snoremap  "_c
nnoremap   za
nnoremap <silent> "" :registers "0123456789abcdefghijklmnopqrstuvwxyz*+.
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/nerdtree/,~/.vim/plugged/vim-peekaboo/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/gundo.vim/,~/.vim/plugged/syntastic/,~/.vim/plugged/ultisnips/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/vimtex/,~/.vim/plugged/vim-ros/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/vimtex/after,~/.vim/after
set shiftwidth=2
set showmatch
